...
new_names <- unlist(flatten_regions)
...
heat_map_country <- ggplot(data=synchrony %>% 
  ...
  ggsave("heatmap2.pdf", device = "pdf", dpi=600, width=12, height=15, units = "cm")


legend <-  get_legend(heat_map)

ggarrange(ggarrange(heat_map, heat_map_country, labels=c("a","b"), nrow=1, ncol=2, legend = F), legend, nrow=2, ncol=1, heights = c(1,0.1)) +
