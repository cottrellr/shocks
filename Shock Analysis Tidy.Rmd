...
#for(target_sector in "Crops"){
  ...
  sector_shocks$Recovery_transparency <- case_when(
    sector_shocks$Recovery2 < 4 ~ 0.1, 
    sector_shocks$Recovery2 > 3 & sector_shocks$Recovery2 < 7 ~ 0.2,
    sector_shocks$Recovery2 > 6 & sector_shocks$Recovery2 < 10 ~ 0.35,
    sector_shocks$Recovery2 > 9 & sector_shocks$Recovery2 < 15 ~ 0.5,
    sector_shocks$Recovery2 > 14 & sector_shocks$Recovery2 < 21 ~ 0.7,
    sector_shocks$Recovery2 > 20 ~ 0.9
  )
...
pdf(file="C:/Users/rsc2/Documents/github/shocks/For submission/rich-cotrell-paper-figure-legend.pdf", width=183*0.0393700787, height=70*0.0393700787)
  ...
  text(x = 1:length(nx), y=rep(12, length(nx)), labels=c("1-3", "4-6", "7-9", "10-14", "15-20", ">20"), cex=0.8)
dev.off()
