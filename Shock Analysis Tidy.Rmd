...
#PLOT FOR SHOCKS DID NOT RECOVER
...
ggplot(data = Norecovery, aes(x=Region, y=Prop, fill=NoRecover))+geom_bar(stat="identity")+facet_wrap(~Sector)+
  theme_bw()+
  scale_fill_manual(values = c("#9e0142","#5e4fa2" ))+
  theme(panel.grid = element_blank(), 
...
fig1<-ggarrange(p1, p3, p2,p4, p5,p7, p6,p8, labels=c("a","c","b","d","e", "g", "f", "h"), ncol=2, nrow=4, legend = "none", align = "hv" , font.label = list(size=10))
